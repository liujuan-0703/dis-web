...
;(function ($, window, document) {
    ...
    Indicator.prototype = {
        ...
        init: function () {
            ...
            ctx.beginPath();
            ctx.arc(center, center, indOption.radius,Math.PI * 0.7, 2.3 * Math.PI); //修改画圆环，重那个坐标点开始，到那个坐标点结束
            ctx.stroke();
        ...
        value: function (val) {
            ...
            ctx.beginPath();
            ctx.arc(center, center, indOption.radius, -(quart + Math.PI * 0.8), (perVal / 100) * (Math.PI * 1.6) - (quart + Math.PI * 0.8), false);
            ctx.stroke();
